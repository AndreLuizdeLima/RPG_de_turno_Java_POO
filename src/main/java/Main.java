...
public class Main {
	...
	public static void main(String[] args) throws SQLException {
		...
		Personagem personagem = new Personagem("Andre", repositoryRaca.buscarRacaPorNome("Humanos"),
				repositoryArquetipo.buscarArquetipoPorNome("Mago"));

		repositoryPersonagem.salvarPersonagem(personagem);

		Personagem personagem2 = new Personagem("Eduar", repositoryRaca.buscarRacaPorNome("Elfos"),
				repositoryArquetipo.buscarArquetipoPorNome("Bardo"));
