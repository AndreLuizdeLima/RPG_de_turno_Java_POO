...
public class Batalha {
	...
	public void iniciaBatalha() {
		...
		if (quemJoga == 1) {
			System.out.println(
					"Iniciando batalha " + personagem1.getNome() + " Ataca primeiro o  " + personagem2.getNome());
			...
			System.out.println(
					"Iniciando batalha " + personagem2.getNome() + " Ataca primeiro o " + personagem1.getNome());
	...
	private void batalha(Personagem jogador1, Personagem jogador2) {
		...
		while (true) {
			...
			if (contador % 2 == 0) {
				...
				int ataqueJogador1 = jogador1.getPoderFisico() + jogador1.getPoderHabilidade()
						+ aleatoriedade.rolaDados();
				System.out.println();
				System.out.println("Ataque do " + jogador1.getNome() + " no jogador " + jogador2.getNome() + ". ATAQUE:"
						+ ataqueJogador1);
				...
				int ataqueJogador2 = jogador2.getPoderFisico() + jogador2.getPoderHabilidade()
						+ aleatoriedade.rolaDados();

				System.out.println("Ataque do " + jogador2.getNome() + " no jogador " + jogador1.getNome() + ". ATAQUE:"
						+ ataqueJogador2);
